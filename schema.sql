...
ALTER TABLE identities ADD COLUMN IF NOT EXISTS email VARCHAR(190) DEFAULT NULL;
ALTER TABLE arrivals ADD COLUMN IF NOT EXISTS join_status ENUM('pending','accepted','declined') DEFAULT NULL;
